          ...
          <div className = "space-y-6">
            ...
            <div className = "relative">
              ...
              <input
                ...
                className = "w-full pl-12 pe-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition"
                value = {role}
            ...
            <select value = {mode}
              ...
              className = "w-full bg-gray-50 border border-gray-200 rounded-xl p-5 space-y-4"
              >
              ...
              whileHover = {{scale : 1.03}}
              whileTap = {{scale : 0.95}}
              className = "w-full disabled:bg-gray-600 bg-green-600 hover:bg-green-700 text-white pu-3 rounded-full text-lg font-semibold transition duration-300 shadow-md"
              >
